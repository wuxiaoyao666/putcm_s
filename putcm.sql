...
-- ----------------------------
-- Table structure for anquan
-- ----------------------------
DROP TABLE IF EXISTS `anquan`;
CREATE TABLE `anquan`  (
  `subId` int NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`subId`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '表110:安全性评价 表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for bencao
-- ----------------------------
DROP TABLE IF EXISTS `bencao`;
CREATE TABLE `bencao`  (
  `subId` int NOT NULL AUTO_INCREMENT,
  `tcmId` int NULL DEFAULT NULL COMMENT '中药ID',
  `t1` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '药材名称',
  `tcmType` int NULL DEFAULT NULL COMMENT '药物类型，1-植物药，2-动物药，3-矿物药，4-其他',
  `t2` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '本草记载',
  `t3` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '名称考证',
  `t4` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '基原考证',
  `t5` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '药用部件考证',
  `t6` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '产地考证',
  `t7` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '性味归经考证',
  `t8` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '功能主治考证',
  `t9` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '用法用量考证',
  `t10` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '备注',
  `userId` int NULL DEFAULT NULL COMMENT '关联表 userinfo',
  `insertTime` bigint NULL DEFAULT NULL,
  `updateTime` bigint NULL DEFAULT NULL,
  PRIMARY KEY (`subId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '表101:本草考证' ROW_FORMAT = Dynamic;
...
CREATE TABLE `captcha`  (
  ...
  `captchaText` char(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '验证码文本，4位数字',
  `genTime` bigint NULL DEFAULT NULL COMMENT '生成时间秒数，超过5分钟则失效',
  PRIMARY KEY (`captchaId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '表002.验证码表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for huaxue
-- ----------------------------
DROP TABLE IF EXISTS `huaxue`;
CREATE TABLE `huaxue`  (
  `subId` int NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`subId`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '表105:化学成分' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for kaifa
-- ----------------------------
DROP TABLE IF EXISTS `kaifa`;
CREATE TABLE `kaifa`  (
  `subId` int NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`subId`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '表112:开发利用' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for linchuang
-- ----------------------------
DROP TABLE IF EXISTS `linchuang`;
CREATE TABLE `linchuang`  (
  `subId` int NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`subId`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '表111:临床应用' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of linchuang
-- ----------------------------

-- ----------------------------
-- Table structure for tcm
-- ----------------------------
DROP TABLE IF EXISTS `tcm`;
CREATE TABLE `tcm`  (
  `tcmId` int NOT NULL,
  `tcmName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `letterIndex` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '首字母索引',
  `allLetter` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '全拼，用于同字母下排序',
  `tcmImg` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '图片完整路径，从/tcm开始，含后缀',
  `insertUserId` int NULL DEFAULT NULL,
  `insertTime` bigint NULL DEFAULT NULL,
  `updateTime` bigint NULL DEFAULT NULL,
  PRIMARY KEY (`tcmId` DESC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '表003:中药名表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of tcm
-- ----------------------------
INSERT INTO `tcm` VALUES (2, '黄芪', 'H', 'huangqi', '/api/file/tcm/7391367557304815616.jpg', 1, 1762239351, 1762239351);
INSERT INTO `tcm` VALUES (1, '红花', 'H', 'honghua', '/api/file/tcm/7391367362588446720.jpg', 1, 1762239307, 1762239307);

-- ----------------------------
-- Table structure for tiqu
-- ----------------------------
DROP TABLE IF EXISTS `tiqu`;
CREATE TABLE `tiqu`  (
  `subId` int NOT NULL AUTO_INCREMENT,
  `tcmId` int NULL DEFAULT NULL COMMENT '中药ID',
  `t1` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '药材基源',
  `t2` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '原植物',
  `t3` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '提取部位',
  `t4` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '预处理方法',
  `t5` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '提取方式',
  `t6` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '提取参数',
  `t7` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '提取设备型号',
  `t8` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '过滤方式',
  `t9` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '过滤参数',
  `t10` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '分离方式',
  `t11` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '分离参数',
  `t12` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '浓缩方式',
  `t13` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '浓缩参数',
  `t14` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '干燥方式',
  `t15` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '干燥参数',
  `t16` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '最终产物形态',
  `t17` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '得率（%）',
  `t18` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '工艺规模',
  `t19` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '目标成分名称',
  `t20` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '目标成分要求',
  `t21` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '目标成分检测方法依据',
  `i1` json NULL COMMENT '相关图谱（list，{img,title}',
  `t22` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '工艺来源',
  `t23` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '引用文献/说明书',
  `t24` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '备注说明',
  `userId` int NULL DEFAULT NULL COMMENT '关联表 userinfo',
  `insertTime` bigint NULL DEFAULT NULL,
  `updateTime` bigint NULL DEFAULT NULL,
  PRIMARY KEY (`subId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '表104:提取分离' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for tmpfile
-- ----------------------------
DROP TABLE IF EXISTS `tmpfile`;
CREATE TABLE `tmpfile`  (
  `tmpFileId` int NOT NULL AUTO_INCREMENT,
  `tmpFilePath` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '从/开始，不含根目录file',
  `fileDesc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '文件描述，如：上传页面等',
  `insertTime` bigint NULL DEFAULT NULL COMMENT '上传时间',
  PRIMARY KEY (`tmpFileId` DESC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '表004:临时添加文件表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `userinfo`  (
  ...
  `recentlyView` json NULL COMMENT '中药ID数组',
  `insertTime` bigint NULL DEFAULT NULL,
  `updateTime` bigint NULL DEFAULT NULL,
  `lastLoginTime` bigint NULL DEFAULT NULL,
  `authToken` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`userId`, `userRole`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '表001.用户表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of userinfo
-- ----------------------------
INSERT INTO `userinfo` VALUES (1, 'admin', 'admin', 1, '[1, 2]', 0, 0, 1763194488, '7395373695016898560');

-- ----------------------------
-- Table structure for wenxian
-- ----------------------------
DROP TABLE IF EXISTS `wenxian`;
CREATE TABLE `wenxian`  (
  `subId` int NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`subId`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '表113:文献数据' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for yaoli
-- ----------------------------
DROP TABLE IF EXISTS `yaoli`;
CREATE TABLE `yaoli`  (
  `subId` int NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`subId`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '表108:药理作用' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for yaowu
-- ----------------------------
DROP TABLE IF EXISTS `yaowu`;
CREATE TABLE `yaowu`  (
  `subId` int NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`subId`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '表109:药物代谢与药代动力学' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for yinpian
-- ----------------------------
DROP TABLE IF EXISTS `yinpian`;
CREATE TABLE `yinpian`  (
  `subId` int NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`subId`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '表107:饮片炮制' ROW_FORMAT = Dynamic;
...
CREATE TABLE `zaipei`  (
  ...
  `tcmId` int NULL DEFAULT NULL COMMENT '中药ID',
  `t1` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '药材名称',
  `t2` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '基原及种质',
  `t3` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '选育品种名称',
  `t4` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '繁育方式',
  `t5` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '播种方式',
  `t6` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '繁殖方式',
  `t7` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '播种或移栽、定植时间',
  `t8` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '田间管理措施',
  `t9` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '大气要求',
  `t10` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '土壤要求',
  `t11` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '肥料使用',
  `t12` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '病虫害防治措施',
  `t13` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '最佳采收期',
  `t14` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '产地加工',
  `t15` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '产量范围',
  `t16` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '适宜生境',
  `t17` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '技术来源',
  `t18` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '参考文献/标准',
  `t19` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '备注',
  `userId` int NULL DEFAULT NULL COMMENT '关联表 userinfo',
  `insertTime` bigint NULL DEFAULT NULL,
  `updateTime` bigint NULL DEFAULT NULL,
  PRIMARY KEY (`subId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '表103:栽培（养殖）技术' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for zhiliang
-- ----------------------------
DROP TABLE IF EXISTS `zhiliang`;
CREATE TABLE `zhiliang`  (
  `subId` int NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`subId`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '表106:质量分析' ROW_FORMAT = Dynamic;
...
CREATE TABLE `zhiwu`  (
  ...
  `tcmId` int NULL DEFAULT NULL COMMENT '中药ID',
  `t1` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '药材基源',
  `t2` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '形态描述',
  `i1` json NULL COMMENT '形态图片（list，{img,title}',
  `t3` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '自然分布区',
  `t4` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '养殖种植区域',
  `t5` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '来源典籍文献',
  `t6` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '备注',
  `userId` int NULL DEFAULT NULL COMMENT '关联表 userinfo',
  `insertTime` bigint NULL DEFAULT NULL,
  `updateTime` bigint NULL DEFAULT NULL,
  PRIMARY KEY (`subId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '表102:原植物（动物）' ROW_FORMAT = Dynamic;
